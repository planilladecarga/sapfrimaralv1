    ...
    fr.onload = () => {
      try {
        ...
        rows.forEach((r) => {
          ...
          const contenedorFinal = usarFormatoStock ? contenedorStock : contenedorAlt;
          ...
          const contenidoFinal = usarFormatoStock ? contenidoStock : contenidoAlt;
          const lote = normalizarTexto(r[1]) || normalizarTexto(r[0]);

          if (!contenedorFinal || !contenidoFinal || cantidadFinal <= 0) return;

          crearContenedor(contenedorFinal, contenedorFinal);
